...
from minecraft_manager.blueprints import error_page
from minecraft_manager.controllers.minecraft import load_servers
...
def create_app(app_name=constants.APPLICATION_NAME):
    ...
    app = Flask(app_name)
    app.config.from_object("minecraft_manager.config.BaseConfig")
    # env = DotEnv(app)
    # cache.init_app(app)
    ...
    from minecraft_manager.blueprints.api import blueprint as api_blueprint
